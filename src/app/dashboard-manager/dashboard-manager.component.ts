...
export class DashboardManagerComponent implements OnInit {
  ...
  constructor(public ersApp:ERSController, public ngZone:NgZone, private router: Router) { 
    if(this.ersApp.currentUser == null || this.ersApp.currentUser == undefined) this.router.navigate(["login"]);
  }

  ngOnInit() { 
    console.log(this.ersApp.currentUser);
  ...
  public submittedDecision(e : any){
    this.ngZone.run(() => {
        this.pendingPage = false;
        this.processedPage = true;
        this.newRequestPage = false;
  ...
  //Pending Requests Component Methods
